            ...
            <div className="flex items-center gap-3">
              ...
              >
                ...
                <div className="relative">
                  ...
                  {user?.avatar ? (
                    <img
                      src={user.avatar}
                      alt="avatar"
                      className="w-12 h-12 rounded-full object-cover border-2 border-[#e8ddd2] shadow-md group-hover:scale-105 transition"
                    />
                  ) : (
                ...
                <div className="leading-tight hidden lg:block">
                  ...
                  <p className="text-sm font-semibold text-[#3d2b2b] group-hover:text-[#6b4f4f] transition">
                    {user.name}
                  </p>
              ...
              <button
                ...
                className="ml-1 text-red-500 hover:text-red-600 transition font-medium text-sm"
              >
                Logout
              </button>
